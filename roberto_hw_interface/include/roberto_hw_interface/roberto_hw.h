...
{
    public:
        Roberto(ros::NodeHandle& nh, int idleft, int idright);
        ~Roberto();
        void init();
    ...
    protected:
        ...
        hardware_interface::VelocityJointInterface velocity_joint_interface_0;
        hardware_interface::VelocityJointInterface velocity_joint_interface_1;
        
        joint_limits_interface::JointLimits limits;
        joint_limits_interface::EffortJointSaturationInterface effortJointSaturationInterface;
        joint_limits_interface::PositionJointSaturationInterface positionJointSaturationInterface;
        
        ctre::phoenix::motorcontrol::can::TalonFX talonleft;
        ctre::phoenix::motorcontrol::can::TalonFX talonright;
