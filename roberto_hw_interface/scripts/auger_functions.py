...
class AugerFunctions:
    ...
    def returnToNeutral(self):
        ...
        self.augerapi.setActuatorPosition(position=92)

    def deployAuger(self):
        if (self.augerapi.bscrew_position > 10000 or self.augerapi.bscrew_position < -10000):
            pass
    ...
    def depositAuger(self):
        if (self.augerapi.bscrew_position > 10000 or self.augerapi.bscrew_position < -10000):
            pass
        self.augerapi.setActuatorPosition(position=100)
